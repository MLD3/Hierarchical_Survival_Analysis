...
def main():
    ...
    #pop  = pat_map['ICUSTAY_ID']
    pop = pat_map.rename(columns={'ICUSTAY_ID': 'ID'})#.set_index('ID')
    print(pop)
    pop['ID'].to_csv(data_path + 'pop.csv', index=False)

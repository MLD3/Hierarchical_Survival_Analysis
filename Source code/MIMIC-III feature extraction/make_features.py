...
#parser.add_argument('--stats_functions', nargs='+', default=['count'])
...
'''
command to run:
python make_features.py --data_path [data_path from config.yaml] --population [where file with ids is stored] --T 5 --dt 0.5 
'''
